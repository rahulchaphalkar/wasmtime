use crate::dsl::{Customization::*, Feature::*, Inst, Location::*, VexLength::*, EvexLength};
use crate::dsl::{align, fmt, inst, r, rex, rw, sxl, sxq, vex, evex, w};
...
pub fn list() -> Vec<Inst> {
    vec![
        ...
        // Evex
        inst("vaddpd", fmt("C", [w(xmm1), r(xmm2), r(xmm_m128)]), evex(EvexLength::L128).r()._66()._0f().op(0x58), _64b | compat | avx10),
        // `LOCK`-prefixed xadd
