...
pub fn list() -> Vec<Inst> {
    vec![
        ...
        //REX+80 /1 ib OR r/m8, imm8 unimplemented
        ...
        //inst("orbw", fmt("MI_SX", [rw(rm16), r(imm8)]), rex(0x83).digit(1).ib(), None),
        //inst("orl", fmt("MI_SX", [rw(rm32), sx(imm8)]), rex(0x83).digit(1).ib(), None),
